...
/**
 * node - adds a node to the start of the list
 ...
 * Return: size of list
 */
list_t *node(list_t **head, const char *str, int num)
{
	list_t *new_head;
...
/**
 * free_list_str - frees all nodes of a list
 * @head_ptr: address of pointer to head node
 *
 * Return: void
 */
void free_list_str(list_t **head_ptr)
{
