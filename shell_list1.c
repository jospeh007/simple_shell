...
/**
 * list_len_str - determines length of linked list
 * @h: pointer to first node
 *
 * Return: size of list
 */
size_t list_len_str(const list_t *h)
{
	size_t i = 0;
...
/**
 * print_list_linked - prints all elements of a list_t linked list
 * @h: pointer to first node
 *
 * Return: size of list
 */
size_t print_list_linked(const list_t *h)
{
	size_t i = 0;
